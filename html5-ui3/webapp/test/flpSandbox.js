		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI 3",
									"targetURL": "#ndbstraininghtml5ui3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ndbstraininghtml5ui3-display": {
								"semanticObject": "ndbstraininghtml5ui3",
								"action": "display",
								"description": "UI 3",
								"title": "UI 3",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ndbs.training.html5ui3",
									"url": sap.ui.require.toUrl("ndbs/training/html5ui3")
								}
							}
						}
					}
